...
export function Home() {
  ...
  useEffect(() => {
    ...
    fetchArticles();
  }, [selectedCategory, debouncedSearchQuery, currentLanguage, currentPage, itemsPerPage, sortOrder, dispatch]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {!isLoading && articles.length === 0 && !error && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              {searchQuery ? t('search.noResults') : 'No articles available for this category.'}
            </p>
            {searchQuery && (
              <button
